...
export const archiveItems: ArchiveItem[] = [
  {
    ...
    title: 'Fotografía de la casa familiar',
    type: 'fotografía',
    description:
      'Placeholder para una imagen de la casa vinculada al origen en Chandrexa de Queixa y al peso material de la memoria.',
    characterIds: ['maria', 'indalecia', 'pedro'],
    locationId: 'chandrexa',
    chapterId: 'chapter-casteligo',
    placeholderLabel: 'Imagen pendiente de archivo',
  },
  {
    id: 'archive-letter-scan',
    title: 'Carta escaneada desde La Habana',
    type: 'carta escaneada',
    description:
      'Espacio reservado para la reproducción facsimilar de la carta enviada por Pedro desde Cuba.',
    characterIds: ['pedro', 'indalecia'],
    locationId: 'habana',
    chapterId: 'chapter-habana',
    placeholderLabel: 'Escaneo en preparación',
  },
  {
    ...
    type: 'árbol familiar',
    description:
      'Versión visual del linaje con notas breves, preparada para crecer con nuevas ramas y documentos.',
    characterIds: ['maria', 'pedro', 'indalecia', 'flora', 'tomas'],
    locationId: 'chandrexa',
    chapterId: 'chapter-descendencia',
    placeholderLabel: 'Diagrama genealógico provisional',
  },
  {
    id: 'archive-port-doc',
    title: 'Documento de salida y puerto',
    type: 'documento',
    description:
      'Placeholder para un documento ligado a Vigo y al momento de la partida transatlántica.',
    characterIds: ['pedro'],
    locationId: 'vigo',
    chapterId: 'chapter-mutin',
    placeholderLabel: 'Documento aún no digitalizado',
  },
  {
    id: 'archive-clock-note',
    title: 'Nota sobre el reloj',
    type: 'material complementario',
    description:
      'Ficha dedicada al recorrido simbólico del reloj, sus transmisiones y su peso narrativo.',
    characterIds: ['pedro', 'flora', 'tomas'],
    locationId: 'sao-paulo',
    chapterId: 'chapter-voz-flora',
    placeholderLabel: 'Comentario curatorial pendiente',
  },
];
